<template>
  <div class="">
    ...
    <div class="flex justify-center items-center flex-col mb-24 mt-20 lg:h-64">
      <h1 class="pb-12 text-2xl text-gray-700">Please confirm your zip code</h1>
      <div class="w-full sm:w-5/6 lg:w-3/6">
        ...
        />
        <div
          class="text-green-400 text-sm font-medium pt-2 flex items-center"
