<template>
  <div class="fixed z-[9999] inset-0 w-full h-full bg-white backdrop-blur-md">
    <button
      type="button"
      @click="CloseModal"
      class="absolute right-3 top-3 size-8 flex justify-center items-center rounded-full border border-brand-dark"
    >
      <svg
    ...
    >
      ...
      >
        ...
        <figure>
          <img
            class="w-full rounded-xl max-h-[calc(100vh-350px)] lg:max-h-[calc(100vh-150px)] object-contain"
      ...
      >
        <div class="flex overflow-x-auto lg:grid grid-cols-1 gap-4 py-3">
          ...
          >
            <figure>
              <img
                class="lg:w-full rounded-xl w-20 h-16 md:w-28 md:h-24 lg:h-40 group-[.active]:border-dark border object-cover"
