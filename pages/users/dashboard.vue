        ...
        <div class="" v-if="isBooking">
          <div class="w-full pt-5 hidden sm:block md:hidden lg:block">
            <table class="table w-full">
              ...
              <tbody>
                <tr v-for="booking in recent_booking" :key="booking.id">
                  <td class="px-3 py-5">
                    <p class="text-sm font-medium">#{{ booking.order_id }}</p>
                  </td>
                  <td class="px-3 py-5">
                    <div
                      ...
                      :key="index"
                    >
                      <p class="text-sm font-medium">{{ ser }}</p>
                    </div>
                  </td>
                  <td class="px-3 py-5">
                    <p class="text-sm font-medium">${{ booking.total }}</p>
                  </td>
                  <td class="px-3 py-5">
          ...
          <div class="pt-6 block sm:hidden md:block lg:hidden">
            ...
            <div
              v-for="booking in recent_booking"
              :key="booking.id"
