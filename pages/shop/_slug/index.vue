          ...
          <div class="flex flex-col lg:flex-row pb-10">
            ...
            <div class="lg:w-5/12 pt-6 lg:pt-0">
              <div class="w-full lg:pt-5">
                ...
                <div class="pb-4 space-y-1.5" v-if="product?.colors.length > 0">
                  <h3 class="font-semibold">Varient:</h3>
